...
type Page = 'overview' | 'agents' | 'releases' | 'evidence' | 'recovery' | 'audit'
  ...
  return (
    <div className="app-shell">
      ...
      <aside className={menuOpen ? 'sidebar sidebar--open' : 'sidebar'}>
        ...
        <div className="sidebar-footer"><p>Role A scope</p><strong>Platform · Data · Evidence</strong><small>Runtime / Policy / Decision calculation excluded</small></div>
      </aside>
      <div className="workspace">
        ...
        <main>
          ...
          {loading ? <LoadingBlock label="Platform inventory를 불러오는 중" /> : <>
            ...
            {page === 'releases' ? <ReleasesPage agents={agents} actorId={actorId} initialAgent={selectedAgent} onReleaseInventory={(items) => setReleases((current) => [...current.filter((release) => release.agentId !== items[0]?.agentId), ...items].sort((a, b) => b.updatedAt.localeCompare(a.updatedAt)))} /> : null}
